...
def checkNumberForDrop(predicted_bag: Set[str], gold_bag: Set[str]):
    gold_numbers = set()
    ...
    if gold_numbers == predicted_numbers and len(gold_numbers)>0:
        return True
    return False
...
def _compute_f1(predicted_bag: Set[str], gold_bag: Set[str]) -> float:
    ...
    ################################################
    #if checkNumberForDrop(predicted_bag, gold_bag):
    #    return 1.0
    #############################################################
...
if __name__ == "__main__":
    predicted_answer = ["0.05"]
    answer = ["0.05%"]
    print(get_metrics(predicted_answer,answer))
